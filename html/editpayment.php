...
$sql = "SELECT * FROM tblpayment WHERE paymentID=$id";
...
{	
	...
	$workerFname = trim($_POST['workerFname']);
	$workerSname = trim($_POST['workerSname']);
	$jobID = trim($_POST['jobID']);
	$paymentAmount = trim($_POST['paymentAmount']);
	$workerPhone = trim($_POST['workerPhone']);
	...
	/*if(empty($name) || empty($age) || empty($email)) {	
		...
		//updating the table
		$sql1 = "UPDATE tblpayment SET paymentID='$paymentID', workerID='$workerID', workerFname='$workerFname', workerSname='$workerSname', jobID='$jobID',
		paymentAmount='$paymentAmount', workerPhone='$workerPhone', paymentStatus='$paymentStatus' WHERE paymentID=$id";
	...
	<div class="container">
		<form name="form1" method="post" action="">
			<table border="0">
				<tr> 
					<td>Payment ID</td>
					<td><input type="text" name="paymentID" readonly value="<?php echo $paymentID;?>"></td>
				</tr>
				...
				<tr> 
					...
					<td><input type="text" name="paymentAmount" required value="<?php echo $paymentAmount;?>"></td>
				</tr>
				<tr> 
