<?php
	include('workerlogin.php'); // Include Login Script
...
<div class="wrapper">
<div align="center">
<h1><a href="http://www.eggslab.net/php-login-script">Worker Login</a></h1>
<table border="0">
<tr>
<td>
...
<br/>
	<div align="center">
		<p>Dont have an account? <a href="worker registration.php">Sign up.</a></p>
	</div>
